 ...
 */
@JvmInline
public value class BrawlifyGameModeVersion private constructor(
    public val rawInt: Int,
) : Comparable<BrawlifyGameModeVersion> {

    override fun compareTo(other: BrawlifyGameModeVersion): Int = rawInt.compareTo(other.rawInt)

    public companion object {
        /** The first valid game mode version. */
        public val FIRST: BrawlifyGameModeVersion =
            BrawlifyGameModeVersion(1)
        ...
        /**
         * Attempts to create a [BrawlifyGameModeVersion] from the given [value].
         *
         * Returns a [Result] that is successful if [value] is valid (≥ [FIRST]),
         * or a failure otherwise.
         */
        public fun create(value: Int): Result<BrawlifyGameModeVersion> {
            return if (value < FIRST.rawInt)
                Result.failure(IllegalArgumentException("Gadget version should at least be one"))
            else Result.success(BrawlifyGameModeVersion(value))
        }

        /**
         * Creates a [BrawlifyGameModeVersion] from the given [value],
         * or throws an [IllegalArgumentException] if the value is invalid.
         */
        public fun createOrThrow(value: Int): BrawlifyGameModeVersion =
            create(value).getOrThrow()

        /**
         * Returns a [BrawlifyGameModeVersion] if [value] is valid, or `null` otherwise.
         */
        public fun createOrNull(value: Int): BrawlifyGameModeVersion? =
