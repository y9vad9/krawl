...
/** Returns `true` if this class ID represents an unknown brawler class. */
public val BrawlifyBrawlerClassId.isUnknown: Boolean
    get() = this == BrawlifyBrawlerClassId.UNKNOWN
