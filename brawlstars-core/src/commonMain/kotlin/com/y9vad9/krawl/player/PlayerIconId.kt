 ...
 */
@JvmInline
public value class PlayerIconId private constructor(public val raw: Int) : Comparable<PlayerIconId> {
    /** Constants with constraints and validation */
    public companion object {
        /** Minimum allowed ID for a valid player icon. */
        public const val MIN_VALUE: Int = 28_000_000
         ...
         */
        public fun isValid(input: Int): Boolean = input >= MIN_VALUE
         ...
         */
        public fun create(input: Int): Result<PlayerIconId> {
         ...
         */
        public fun createOrThrow(input: Int): PlayerIconId = create(input).getOrThrow()

        /**
         * Attempts to create a [PlayerIconId] from the given [input] or returns `null` if invalid.
         */
        public fun createOrNull(input: Int): PlayerIconId? = create(input).getOrNull()
    }
