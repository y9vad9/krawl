...
import com.y9vad9.krawl.IncompleteReturningData
 ...
 */
public data class PlayerVictories(
    public val solo: VictoriesAmount,
    public val duo: VictoriesAmount,
    public val trio: VictoriesAmount,
)
 ...
 */
@IncompleteReturningData
public val PlayerVictories.total: VictoriesAmount get() = solo + duo + trio
