 ...
 */
@JvmInline
public value class PlayerExpPoints private constructor(
    public val int: Int
    ...
    public companion object {
         ...
         */
        public fun create(input: Int): Result<PlayerExpPoints> =
         ...
         */
        public fun createOrThrow(input: Int): PlayerExpPoints =
         ...
         */
        public fun createOrNull(input: Int): PlayerExpPoints? =
