 ...
 */
@JvmInline
public value class PlayerTag private constructor(
    ...
    public companion object {
         ...
         * if invalid.
         */
        public fun create(input: String): Result<PlayerTag> =
         ...
         */
        public fun createOrThrow(input: String): PlayerTag =
         ...
         * This is a convenience wrapper around [create].
         */
        public fun createOrNull(input: String): PlayerTag? =
