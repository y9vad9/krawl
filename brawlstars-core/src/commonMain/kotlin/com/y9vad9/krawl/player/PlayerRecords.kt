...
import com.y9vad9.krawl.player.PlayerRecords.Companion.create
import com.y9vad9.krawl.player.PlayerRecords.Companion.createOrNull
import com.y9vad9.krawl.player.PlayerRecords.Companion.createOrThrow
...
public data class PlayerRecords private constructor(
    public val bestRoboRumbleTime: Duration,
    public val bestTimeAsBigBrawler: Duration,
) {
    public companion object {
         ...
         */
        public fun isValid(bestRoboRumbleTime: Duration, bestTimeAsBigBrawler: Duration): Boolean =
