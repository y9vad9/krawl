 ...
 */
@JvmInline
public value class PlayerExpLevel private constructor(
    public val int: Int
    ...
    public companion object {
         ...
         */
        public fun create(input: Int): Result<PlayerExpLevel> =
         ...
         */
        public fun createOrThrow(input: Int): PlayerExpLevel =
         ...
         */
        public fun createOrNull(input: Int): PlayerExpLevel? =
