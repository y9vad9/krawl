 ...
 */
@JvmInline
public value class EnemyBotsLevelId private constructor(public val rawInt: Int) : Comparable<EnemyBotsLevelId> {
    /**
    ...
    public companion object {
        ...
        public val HARD: EnemyBotsLevelId = EnemyBotsLevelId(1)

        /** Expert difficulty (level 2). */
        public val EXPERT: EnemyBotsLevelId = EnemyBotsLevelId(2)

        /** Master difficulty (level 3). */
        public val MASTER: EnemyBotsLevelId = EnemyBotsLevelId(3)

        /** Insane difficulty (level 4). */
        public val INSANE: EnemyBotsLevelId = EnemyBotsLevelId(4)

        /** Insane 2 difficulty (level 5). */
        public val INSANE_2: EnemyBotsLevelId = EnemyBotsLevelId(5)

        /** Insane 3 difficulty (level 6). */
        public val INSANE_3: EnemyBotsLevelId = EnemyBotsLevelId(6)

        /** Insane 4 difficulty (level 7). */
        public val INSANE_4: EnemyBotsLevelId = EnemyBotsLevelId(7)
         ...
         */
        public fun isValid(raw: Int): Boolean =
            raw > 0
         ...
         */
        public fun create(raw: Int): Result<EnemyBotsLevelId> =
         ...
         */
        public fun createOrNull(raw: Int): EnemyBotsLevelId? =
         ...
         */
        public fun createOrThrow(raw: Int): EnemyBotsLevelId =
...
public fun EnemyBotsLevelId.isHard(): Boolean = this == EnemyBotsLevelId.HARD

/** Returns `true` if this is [EnemyBotsLevelId.EXPERT]. */
public fun EnemyBotsLevelId.isExpert(): Boolean = this == EnemyBotsLevelId.EXPERT

/** Returns `true` if this is [EnemyBotsLevelId.MASTER]. */
public fun EnemyBotsLevelId.isMaster(): Boolean = this == EnemyBotsLevelId.MASTER

/** Returns `true` if this is [EnemyBotsLevelId.INSANE]. */
public fun EnemyBotsLevelId.isInsane(): Boolean = this == EnemyBotsLevelId.INSANE

/** Returns `true` if this is [EnemyBotsLevelId.INSANE_2]. */
public fun EnemyBotsLevelId.isInsane2(): Boolean = this == EnemyBotsLevelId.INSANE_2

/** Returns `true` if this is [EnemyBotsLevelId.INSANE_3]. */
public fun EnemyBotsLevelId.isInsane3(): Boolean = this == EnemyBotsLevelId.INSANE_3

/** Returns `true` if this is [EnemyBotsLevelId.INSANE_4]. */
public fun EnemyBotsLevelId.isInsane4(): Boolean = this == EnemyBotsLevelId.INSANE_4
 ...
 */
public fun EnemyBotsLevelId.isAtMostExpert(): Boolean =
 ...
 */
public fun EnemyBotsLevelId.isAtLeastMaster(): Boolean =
 ...
 */
public fun EnemyBotsLevelId.isAtLeastInsane(): Boolean =
 ...
 * @receiver The current Last Stand difficulty level.
 */
public fun EnemyBotsLevelId.isInsaneTier(): Boolean =
    this >= EnemyBotsLevelId.INSANE
