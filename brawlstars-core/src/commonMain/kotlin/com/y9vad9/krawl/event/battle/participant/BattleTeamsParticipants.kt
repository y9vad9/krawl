 ...
 */
public sealed interface BattleTeamsParticipants {

    /**
     * List of [BattleParticipants] grouped by team.
     */
    public val list: List<BattleParticipants>
     ...
     */
    public operator fun get(index: Int): BattleParticipants?
     ...
     * @return The team at the given index, or `null`.
     */
    public fun getOrNull(index: Int): BattleParticipants?
     ...
     */
    public fun getOrThrow(index: Int): BattleParticipants
     ...
     */
    public fun findParticipantOrNull(tag: PlayerTag): BattleParticipant?
     ...
     */
    public fun findParticipantOrThrow(tag: PlayerTag): BattleParticipant
     ...
     */
    public fun getTeamOrNull(tag: PlayerTag): BattleParticipants?
     ...
     */
    public fun getTeamOrThrow(tag: PlayerTag): BattleParticipants
}
 ...
 */
public fun BattleTeamsParticipants.firstTeam(): BattleParticipants = getOrThrow(0)

/**
 * Returns the second team in the battle, or `null` if it doesn't exist.
 */
public fun BattleTeamsParticipants.secondTeamOrNull(): BattleParticipants? = getOrNull(1)
 ...
 */
public fun BattleTeamsParticipants.secondTeamOrThrow(): BattleParticipants = getOrThrow(1)

/**
 * Returns the third team in the battle, or `null` if it doesn't exist.
 */
@Suppress("detekt.MagicNumber")
public fun BattleTeamsParticipants.thirdTeamOrNull(): BattleParticipants? = getOrNull(2)
 ...
 */
@Suppress("detekt.MagicNumber")
public fun BattleTeamsParticipants.thirdTeamOrThrow(): BattleParticipants = getOrThrow(2)

/**
 * Returns the fourth team in the battle, or `null` if it doesn't exist.
 */
@Suppress("detekt.MagicNumber")
public fun BattleTeamsParticipants.fourthTeamOrNull(): BattleParticipants? = getOrNull(3)
 ...
 */
@Suppress("detekt.MagicNumber")
public fun BattleTeamsParticipants.fourthTeamOrThrow(): BattleParticipants = getOrThrow(3)

/**
 * Returns the fifth team in the battle, or `null` if it doesn't exist.
 */
@Suppress("detekt.MagicNumber")
public fun BattleTeamsParticipants.fifthTeamOrNull(): BattleParticipants? = getOrNull(4)
 ...
 */
@Suppress("detekt.MagicNumber")
public fun BattleTeamsParticipants.fifthTeamOrThrow(): BattleParticipants = getOrThrow(4)
 ...
 */
public data class FriendlyBattleTeamsParticipants(
 ...
 */
public fun FriendlyBattleTeamsParticipants.findPlayerOrNull(tag: PlayerTag): BattlePlayer? =
 ...
 * @throws IllegalStateException if no participant with the given tag exists.
 */
public fun FriendlyBattleTeamsParticipants.findPlayerOrThrow(tag: PlayerTag): BattlePlayer =
 ...
 */
public fun FriendlyBattleTeamsParticipants.findBotOrNull(tag: PlayerTag): BattleBot? =
 ...
 * @throws IllegalStateException if no participant with the given tag exists.
 */
public fun FriendlyBattleTeamsParticipants.findBotOrThrow(tag: PlayerTag): BattleBot =
 ...
 */
public data class RankedBattleTeamsPlayers(
 ...
 */
public data class TrophyLeagueBattleTeamsPlayers(
