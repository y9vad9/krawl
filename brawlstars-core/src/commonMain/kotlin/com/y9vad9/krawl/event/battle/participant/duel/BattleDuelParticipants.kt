 ...
 * such as [FriendlyDuelBattleParticipants], [RankedBattlePlayers], or [TrophyLeagueBattleDuelPlayers].
 *
 ...
 */
public sealed interface BattleDuelParticipants {
    /**
     * The list of individual participants in the battle.
     */
    public val list: List<BattleDuelParticipant>
     ...
     */
    public fun getParticipantOrNull(tag: PlayerTag): BattleDuelParticipant?
    ...
    public fun getParticipantOrThrow(tag: PlayerTag): BattleDuelParticipant

    /**
     * Returns the first participant of this duel.
     */
    public val first: BattleDuelParticipant

    /**
     * Returns the second participant of this duel.
     */
    public val second: BattleDuelParticipant
}
 ...
 * > instead of multiple. Adjust your application logic accordingly.
 */
public data class FriendlyDuelBattleParticipants(
 ...
 */
public fun FriendlyDuelBattleParticipants.getAsPlayerOrNull(tag: PlayerTag): BattleDuelPlayer? =
 ...
 * @throws IllegalStateException if no participant with the given tag exists.
 */
public fun FriendlyDuelBattleParticipants.getAsPlayerOrThrow(tag: PlayerTag): BattleDuelPlayer =
 ...
 */
public fun FriendlyDuelBattleParticipants.getAsBotOrNull(tag: PlayerTag): BattleDuelBot? =
 ...
 * @throws IllegalStateException if no participant with the given tag exists.
 */
public fun FriendlyDuelBattleParticipants.getAsBotOrThrow(tag: PlayerTag): BattleDuelBot =
 ...
 */
public data class TrophyLeagueBattleDuelPlayers(
