...
import com.y9vad9.krawl.brawler.BrawlerPowerLevel.Companion.MAX
...
public value class BrawlerPowerLevel private constructor(
    ...
    public companion object {
         ...
         */
        public const val MAX_VALUE: Int = 11
         ...
         */
        public val MIN: BrawlerPowerLevel = BrawlerPowerLevel(MIN_VALUE)

        /**
         * Constant representing the maximum [BrawlerPowerLevel] (level 11).
         */
        public val MAX: BrawlerPowerLevel = BrawlerPowerLevel(MAX_VALUE)
         ...
         */
        public fun create(input: Int): Result<BrawlerPowerLevel> =
         ...
         */
        public fun createOrThrow(input: Int): BrawlerPowerLevel =
         ...
         * @param input The integer value to create the power level from.
         */
        public fun createOrNull(input: Int): BrawlerPowerLevel? =
