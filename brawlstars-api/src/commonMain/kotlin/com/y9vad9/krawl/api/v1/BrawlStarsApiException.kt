 ...
 * [ClientError] payload returned by the server, providing both
 ...
 * (HTTP 400 — `badRequest`).
 */
public class BadRequestException(error: ClientError) : BrawlStarsApiException(
 ...
 */
public class AccessDeniedException(error: ClientError) : BrawlStarsApiException(
 ...
 */
public class LimitsExceededException(error: ClientError) : BrawlStarsApiException(
 ...
 */
public class InternalServerErrorException(error: ClientError) : BrawlStarsApiException(
 ...
 */
public class UnderMaintenanceException(error: ClientError) : BrawlStarsApiException(
