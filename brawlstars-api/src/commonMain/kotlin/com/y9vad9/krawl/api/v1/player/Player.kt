 ...
 * @property icon The player's profile icon, represented by a [PlayerIcon] object.
 ...
 * @property club The player's club affiliation, represented by a [PlayerClub] object.
 * @property brawlers A list of the player's brawlers, each represented by a [PlayerBrawler]
...
public data class Player(
    ...
    val club: PlayerClub,
    val brawlers: List<PlayerBrawler>
)
