...
import com.y9vad9.krawl.brawlify.api.v1.event.statistics.BrawlerStatistics
import com.y9vad9.krawl.brawlify.api.v1.event.statistics.TeamStatistics
...
public data class BrawlifyMap(
    ...
    val environment: BrawlifyMapEnvironment,
    val gameMode: BrawlifyGameModeView,
    val lastActive: Long? = null,
    val dataUpdated: Long? = null,
    val stats: List<BrawlerStatistics> = emptyList(),
    val teamStats: List<TeamStatistics> = emptyList(),
)
