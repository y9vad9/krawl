...
import com.y9vad9.brawlstars.types.brawler.value.BrawlerId.Companion
...
public value class BrawlerId private constructor(public val value: Int) : Comparable<BrawlerId> {
    public companion object : ValueFactory<BrawlerId, Int> by factory(
        rules = listOf(
            MinValueValidationRule(16000000),
            MaxNumberValueValidationRule(16001000)
        ),
